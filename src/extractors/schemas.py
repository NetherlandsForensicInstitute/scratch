...
class ComparisonResponse(BaseResponseURLs):
    ...
    compairison_overview: HttpUrl = Field(
        description="",
        examples=["http://localhost:8000/preprocessor/files/surface_comparator_859lquto/profile.json"],
        json_schema_extra={"file_name": "compairison_overview.png"},  # TODO: find out return type/extension
    )
...
class ComparisonResponseImpression(ComparisonResponse):
    ...
    cell_accf_distribution: HttpUrl = Field(
        description="",
        examples=["http://localhost:8000/preprocessor/files/surface_comparator_859lquto/profile.json"],
        json_schema_extra={"file_name": "cell_accf_distribution.png"},  # TODO: find out return type/extension
    )
...
class ComparisonResponseStriation(ComparisonResponse):
    mark_ref_depthmap: HttpUrl = Field(
        description="",
        examples=["http://localhost:8000/preprocessor/files/surface_comparator_859lquto/profile.json"],
        json_schema_extra={"file_name": "mark_ref_depthmap.png"},  # TODO: find out return type/extension
    )
    ...
    similarity_plot: HttpUrl = Field(
        description="",
        examples=["http://localhost:8000/preprocessor/files/surface_comparator_859lquto/profile.json"],
        json_schema_extra={"file_name": "similarity_plot.png"},  # TODO: find out return type/extension
    )
    mark_comp_filtered_surfacemap: HttpUrl = Field(
        description="",
        examples=["http://localhost:8000/preprocessor/files/surface_comparator_859lquto/profile.json"],
        json_schema_extra={"file_name": "mark_comp_filtered_surfacemap.png"},  # TODO: find out return type/extension
    )
    mark1_vs_moved_mark2: HttpUrl = Field(
        description="",
        examples=["http://localhost:8000/preprocessor/files/surface_comparator_859lquto/profile.json"],
        json_schema_extra={"file_name": "mark1_vs_moved_mark2.png"},  # TODO: find out return type/extension
    )
