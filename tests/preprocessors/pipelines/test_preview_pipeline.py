...
class TestPreviewPipeline:
    ...
    def test_generate_preview_success(self, parsed_al3d_file: ImageContainer, tmp_path: Path) -> None:
    ...
    def test_preview_is_valid_png_image(self, parsed_al3d_file: ImageContainer, tmp_path: Path) -> None:
