...
def default_parameters() -> UploudScanParameters:
    return UploudScanParameters.model_construct()


@pytest.fixture(scope="session")
def parsed_al3d_file(scan_directory: Path, default_parameters: UploudScanParameters) -> ScanImage:
