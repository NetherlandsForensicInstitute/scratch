...
def process_prepare_mark(
    ...
    files = get_files(
        ...
        mark_mat="mark.mat",
        processed_mat="processed.mat",
        profile_mat="profile.mat",
        levelled_mat="levelled.mat",
    )
    # TODO: profile.mat and levelled.mat should be one, but naming is not known yet.
