...
def remove_boundary_zeros(
    ...
    :param profile_1: First profile (reference).
    :param profile_2: Second profile (compared).
    :returns: Tuple of (cropped_1, cropped_2, start_position) where:
        - cropped_1: First profile depth_data with boundary zeros removed
        - cropped_2: Second profile depth_data with boundary zeros removed
