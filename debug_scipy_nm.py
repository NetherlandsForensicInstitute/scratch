...
result = minimize(
    wrapped_fun, x0u, method="Nelder-Mead", options={"xatol": 1e-6, "fatol": 1e-6, "maxiter": 400, "maxfev": 400}
)
...
v2 = x0u.copy()
v2[1] *= 1 + usual_delta
print("Simplex vertices (unconstrained):")
print(f"  v0 = {v0}")
print(f"  v1 = {v1}")
print(f"  v2 = {v2}")
...
print("Simplex vertices (bounded):")
print(f"  b0 = {b0}")
print(f"  b1 = {b1}")
print(f"  b2 = {b2}")
