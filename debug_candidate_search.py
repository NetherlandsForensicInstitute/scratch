...
for test_name in ["edge_over_threshold", "partial_with_nans"]:
    ...
    ref_profile = Profile(depth_data=ref_data, pixel_size=pixel_size_ref, cutoff_hi=cutoff_hi, cutoff_lo=cutoff_lo)
    comp_profile = Profile(depth_data=comp_data, pixel_size=pixel_size_comp, cutoff_hi=cutoff_hi, cutoff_lo=cutoff_lo)
