...
def _grayscale_to_rgba(data: FloatArray2D) -> ImageRGBA:
    """
    ...
    :param data: The grayscale image data to be converted to an 8-bit RGBA image.
...
def scan_to_image(scan_image: ScanImage) -> Image:
    return fromarray(_grayscale_to_rgba(data=scan_image.data))
