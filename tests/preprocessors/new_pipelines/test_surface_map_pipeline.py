...
from preprocessors.new_pipelines import surface_map_pipeline
...
class TestSurfaceMapPipeline:
    ...
    def test_generate_surface_map_success(
        ...
        # Act
        surface_map = surface_map_pipeline(parsed_al3d_file, output_path, light_sources, observer, Point(x=1.0, y=1.0))
    ...
    def test_surface_map_with_multiple_lights(self, parsed_al3d_file: ScanImage, tmp_path: Path) -> None:
        ...
        surface_map = surface_map_pipeline(
            parsed_al3d_file, tmp_path / "multi_light_surface_map.png", light_sources, observer, Point(x=1.0, y=1.0)
        )
