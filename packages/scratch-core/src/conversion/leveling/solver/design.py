...
def build_design_matrix(xs: FloatArray1D, ys: FloatArray1D, terms: SurfaceTerms) -> FloatArray2D:
    """
    Construct the Least Squares design matrix based on grid coordinates (xs, ys) and requested terms.
