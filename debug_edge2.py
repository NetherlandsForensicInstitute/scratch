...
# Candidate search
cand_pos, shape_scales, comp_scale = find_match_candidates(profile_ref, profile_comp,
    AlignmentParameters(cutoff_hi=1e-3, cutoff_lo=5e-6))
...
print(f"\n{'='*80}")
print(f"ALIGNMENT STEP-BY-STEP")
...
print(f"\n{'='*80}")
print(f"RUNNING FULL align_profiles_multiscale")
params = AlignmentParameters(
    scale_passes=adjusted_passes,
