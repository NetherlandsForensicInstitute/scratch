...
class TestMarkImpressionExceptionHandlers:
    ...
    def test_no_consensus_pose_is_reported_as_null(self, client: TestClient, json_data: dict) -> None:
        """A comparison without consensus geometry serializes, reporting a null pose and null residuals."""
        ...
        assert body["comparison_results"]["estimated_translation"] is None
        assert body["cells"][0]["meta_data"]["residual_angle_deg"] is None
        assert body["cells"][0]["meta_data"]["position_error"] is None
