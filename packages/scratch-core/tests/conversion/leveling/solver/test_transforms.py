...
def test_denormalize_parameters_returns_all_terms(terms: SurfaceTerms):
...
@pytest.mark.parametrize("terms", SURFACE_TERMS)
def test_denormalize_parameters_adjusts_terms(terms: SurfaceTerms):
    initial_value = 1.5
    params = denormalize_parameters(
...
def test_denormalize_parameters_matches_baseline_output():
    params = denormalize_parameters(
